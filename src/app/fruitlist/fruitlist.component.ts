...
export class FruitlistComponent {
  ...
  fontColorGood = 'rgb(0, 12, 252)';
  fontColorBad = 'red';

  fruitlist = [
    {
      name: "Apfel",
      botanicName: "Malus Domestica Rosaceae",
      img:"apple.png",
    ...
    {
      name: "Banane",
      botanicName: "Musa  Paradisiaca Musaceae",
      img:"banana.png",
    ...
    {
      name: "Sauerkirsche",
      botanicName: "Prunus cerasus Rosaceae",
      img:"cherry.png",
    ...
    {
      name: "Erdbeere",
      botanicName: "Fragaria Ananasa Rosaceae",
      img:"strawberry.png",
    ...
    {
      name: "Zitrone",
      botanicName: "Citrus Sapniades Rutaceae",
      img:"lemon.png",
    ...
    {
      name: "Orange",
      botanicName: "Citrus sinensis Rutaceae",
      img:"orange.png",
